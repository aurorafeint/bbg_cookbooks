...
Author:: Lee Huffman (<lee.huffman@blueboxgrp.com>) - mysql::client, default, server

Author:: Christian Paredes (<christian.paredes@blueboxgrp.com>) - mysql::master, slave, dualmaster
